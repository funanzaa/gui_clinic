...
class Ui_form_database(object):
    def setupUi(self, form_database):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/database-storage.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.lineEdit_user.setText(getCon.user)  # set port
        ...
        self.actionVersion_Postgres = QtGui.QAction(form_database)
